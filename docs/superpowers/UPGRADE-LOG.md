...
| P4: 7.1→7.2 | 3.3.12 | 7.2.3 | 24 | Detection clean. rspec-rails 5.1→7.1.1 (5.x calls fixture_path= which 7.2 removed) + rails_helper fixture_path→fixture_paths. load_defaults 7.2. | (this commit) |
